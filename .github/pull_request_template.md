...
<!--You are an expert ATF Firmware developer. Analyze the following pull request changes and determine which hardware subsystems or features are affected.
    Instructions:
    * exclude test_config.json with disabled=1
    * -- add your additional prompt here --
